...
function App() {
  ...
  // Handle default case when authState is not 'login', 'register', or when user is null
  return <div className='font-bold text-center text-5xl'>Invalid authentication state</div>;
}
